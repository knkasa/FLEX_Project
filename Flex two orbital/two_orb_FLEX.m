...
%        Nk=[ 16 16 ]  filling0=1.75 
%        U=1.5, J1=1.2, U2=0.5, J2=J1, numwi=845,  T=30K
%        
%    U=1.5, J1=1.0, U2=1.2, J2=J1, numwi=2^13, Tc=90K, filling0=1.88 (paper)
%    Try changing gap_input, increase numwi
